 ...
 * @author Sudeep
 */
public class PerlProjectCustomizerProperties implements CustomizerProvider {

    public final PerlProject project;

    public static final String CUSTOMIZER_FOLDER_PATH
            = "Projects/org-perl-project/Customizer";

    public PerlProjectCustomizerProperties(PerlProject project) {
