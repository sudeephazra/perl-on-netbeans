...
@TemplateRegistration(folder = "Project/Perl", 
        displayName = "#PerlProject_displayName", description = "PerlProjectDescription.html", iconBase = "org/language/perl/project/PerlProject.png", content = "PerlProjectProject.zip")
